...
// Regular sizes
#define BACKGROUND_SIZE_REG_256x256 0
#define BACKGROUND_SIZE_REG_512x256 1
#define BACKGROUND_SIZE_REG_256x512 2
#define BACKGROUND_SIZE_REG_512x512 3

// Affine sizes
#define BACKGROUND_SIZE_AFF_128x128   0
#define BACKGROUND_SIZE_AFF_256x256   1
#define BACKGROUND_SIZE_AFF_512x512   2
#define BACKGROUND_SIZE_AFF_1024x1024 3
