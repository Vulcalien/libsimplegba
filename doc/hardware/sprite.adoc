...
== NAME
sprite_config, sprite_hide, sprite_hide_range, sprite_affine,
sprite_mosaic - sprite functions
...
**void sprite_config(i32 **__id__**, const struct Sprite +++*+++**__config__**);**
...
**void sprite_mosaic(i32 **__x__**, i32 **__y__**);**
____
...
16-bit fixed-point numbers scaled by a factor of 256.

The *sprite_mosaic*() function sets the parameters of the mosaic graphic
effect of sprites. When enabled, the image is stretched by (_x_ & 15)
pixels horizontally and (_y_ & 15) pixels vertically.
